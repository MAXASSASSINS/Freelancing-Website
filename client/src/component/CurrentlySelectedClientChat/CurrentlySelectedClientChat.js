...
export const CurrentlySelectedClientChat = ({ user, hideMessageListOnSmallDevices, setHideMessageListOnSmallDevices, currentSelectedClient, handleAllClientUserLastMessage}) => {
  ...
  return (
    <div style={{ display: hideMessageListOnSmallDevices ? "none" : "block" }} className='current-user-message-list'>
      {
        inboxMessages == null ?
          (
            <div className='inbox-message-list-default'>
              <div className='inbox-message-list-default-wrapper'>
                <svg xmlns="http://www.w3.org/2000/svg" width="108" height="88" viewBox="0 0 108 88"><g transform="translate(4 4)"><ellipse fill-rule="evenodd" clip-rule="evenodd" fill="#FFF" cx="54" cy="32.5" rx="17" ry="17.5" /><path fill-rule="evenodd" clip-rule="evenodd" fill="#1DBF73" d="M57 23c0-1.2-.8-2-2.1-2H17.1c-1.3 0-2.1.8-2.1 2s.9 2 2.1 2h37.8c1.3 0 2.1-.8 2.1-2m-22 8H17c-1.2 0-2 .8-2 2s.8 2 2 2h18c1.2 0 2-.8 2-2s-1-2-2-2" /><path fill-rule="evenodd" clip-rule="evenodd" fill="#555" d="M43.7 53.4c-.4 0-1 .2-1.5.4L24.5 69.4V54.8c0-1-.6-1.9-1.7-2.1-10.7-2-18.6-12.2-18.6-24 0-13.5 10-24.5 22.4-24.5h24.9c12.3 0 22.4 11 22.4 24.5s-10 24.5-22.4 24.5l-7.8.2zM51.4 0H26.6C11.9 0 0 12.9 0 28.7 0 42 8.4 53.4 20.3 56.5v17.4c0 .8.4 1.5 1.3 1.9.2.2.6.2.8.2.4 0 1-.2 1.5-.4l20.7-18.1h7.1C66.1 57.5 78 44.6 78 28.7 78 12.9 66.1 0 51.4 0z" /><path fill="none" stroke="#FFF" stroke-width="4" d="M43.7 51.4l7.8-.2c11.2 0 20.4-10.1 20.4-22.5S62.6 6.2 51.4 6.2H26.6c-11.2 0-20.4 10-20.4 22.5 0 10.9 7.3 20.2 17 22.1 2 .4 3.3 2 3.3 4v10.1l14.7-12.8.2-.1c.7-.4 1.5-.6 2.3-.6h0zm1.6 8.1L25 77.3l-.2.1c-.8.3-1.7.6-2.4.6-.2 0-.5 0-.7-.1-.4-.1-.8-.2-1.2-.5-1.4-.8-2.1-2-2.1-3.5V58C6.3 54.1-2 42.3-2 28.7-2 11.8 10.8-2 26.6-2h24.9C67.2-2 80 11.8 80 28.7c0 17-12.7 30.9-28.3 30.9h-6.4v-.1z" /><path fill-rule="evenodd" clip-rule="evenodd" fill="#555" d="M83.6 30.2c-1.2 0-2.1.8-2.1 2.1 0 1.2.8 2.1 2.1 2.1 8.3 0 15.2 7.5 15.2 16.8 0 9.1-6.4 16.6-14.7 16.8-1 0-2.1 1-2.1 2.1v6.6l-7.7-8.1c-.4-.4-1-.6-1.5-.6h-6.6c-4.8 0-9.1-2.5-12-6.6-.6-1-1.9-1.2-2.9-.6s-1.2 1.9-.6 2.9c3.5 5.4 9.6 8.5 15.6 8.5H72l10.8 11.2c.4.4 1 .6 1.5.6.2 0 .6 0 .8-.2.8-.4 1.2-1 1.2-1.9V72c9.6-1.5 16.8-10.2 16.8-20.8.1-11.4-8.7-21-19.5-21" /></g></svg>
          ...
          (
            <div className='inbox-message-list'>
              <div className='inbox-message-list-section-1'>
                <header>
                  <div className='inbox-message-list-header-icon' onClick={() => setHideMessageListOnSmallDevices(true)}>
