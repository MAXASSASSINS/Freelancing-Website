        ...
        <div className='right-side'>
          ...
          <div className='category-section'>
            ...
            {/* <SelectInput
              ...
              isSubOption={true}
              mainOption={selectedCategory ? selectedCategory : null}
              defaultMainOption={'Select a category'}
              style={{ textTransform: 'uppercase' }}
            /> */}
            ...
            !showQuestions ?
              /* <div className='add-question-wrapper'>
                <header>
                  ...
                  <CheckInput
                    label='Required'
                    reference={questionRequiredInputRef}
                  />
                </header>
  ...
  
                    {
                      ...
                      <div className=''>
                        <CheckInput
                          ...
                          reference={enableMultipleOptionsInputRef}
                        />
                      </div>
                    }
                  </div>
                ...
                <div className='add-cancel-buttons-wrapper'>
                  ...
                  <button className='add-question' onClick={handleAddQuestion}>Add</button>
                </div>
