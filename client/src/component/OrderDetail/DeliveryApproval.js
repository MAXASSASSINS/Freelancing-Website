      ...
      {!showRevision ? (
        <div className="flex-grow mr-6">
          ...
          <div className="flex items-center gap-4 mt-6">
            <button onClick={() => setShowFinalDeliveryConfirmation(true)} className="bg-primary text-white px-4 py-2 rounded-sm hover:bg-primary_hover hover:cursor-pointer">
        ...
        <div className="fixed inset-0 w-full h-full z-50 bg-[rgba(0,0,0,0.4)] flex items-center justify-center">
          <div className="bg-white w-5/6 sm:w-[60ch] rounded-sm">
            <div className="flex justify-between rounded-sm text-lg text-light_grey bg-dark_separator px-4 py-3">
              ...
              <IoClose onClick={() => setShowFinalDeliveryConfirmation(false)} className="hover:cursor-pointer" />
            </div>
            ...
            <div className="flex items-center justify-end p-4 gap-4 text-sm">
              <button onClick={() => setShowFinalDeliveryConfirmation(false)} className="capitalize border border-light_heading text-light_heading font-semibold py-1.5 px-3 rounded hover:text-dark_grey hover:cursor-pointer">
                Cancel
              </button>
              <button onClick={handleOrderCompletion} className="capitalize bg-primary py-1.5 px-3 hover:bg-primary_hover text-white rounded hover:cursor-pointer">
